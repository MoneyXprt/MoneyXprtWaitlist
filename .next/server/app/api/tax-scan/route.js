"use strict";(()=>{var e={};e.id=261,e.ids=[261],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},4770:e=>{e.exports=require("crypto")},1235:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>g,patchFetch:()=>h,requestAsyncStorage:()=>u,routeModule:()=>p,serverHooks:()=>m,staticGenerationAsyncStorage:()=>d});var n={};a.r(n),a.d(n,{POST:()=>l});var i=a(9303),s=a(8716),r=a(3131),o=a(7070),c=a(7114);async function l(e){try{let t=(await e.formData()).get("file");if(!(t instanceof Blob))return o.NextResponse.json({error:"PDF is required (field name: file)"},{status:400});let a=`Please provide comprehensive tax optimization strategies focusing on:
