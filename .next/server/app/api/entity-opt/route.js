"use strict";(()=>{var e={};e.id=925,e.ids=[925],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2026:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>g,patchFetch:()=>h,requestAsyncStorage:()=>d,routeModule:()=>p,serverHooks:()=>m,staticGenerationAsyncStorage:()=>u});var s={};n.r(s),n.d(s,{POST:()=>l});var a=n(9303),i=n(8716),r=n(3131),o=n(7070),c=n(6578);async function l(e){try{let{w2:t,re_units:n,side_income:s}=await e.json().catch(()=>({})),a=`Please analyze and recommend optimal entity structures for this situation:
